# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Paleospeleology3D.py
# Created on: 2022-06-04 15:22:00.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: Paleospeleology 1.0 (® I. Intxaurbe)
...
# Execute CreateFolder
arcpy.CreateFolder_management("C:/Paleospeleology", "Rock-Art")

#   for standard output
arcpy.env.workspace = "C:/Paleospeleology/Rock-Art"

# Process: Import 3D Files
arcpy.Import3DFiles_3d(GU_wrl, GU3D_shp, "ONE_ROOT_ONE_FEATURE", "PROJCS['ETRS_1989_ETRS-TM30',GEOGCS['GCS_ETRS_1989',DATUM['D_ETRS_1989',SPHEROID['GRS_1980',6378137.0,298.257222101]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',-3.0],PARAMETER['Scale_Factor',0.9996],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]];-5120900 -9998100 10000;-100000 10000;-100000 10000;0,001;0,001;0,001;IsHighPrecision", "Z_IS_UP", "*", "", "")

# Process: Multipatch to Raster
arcpy.MultipatchToRaster_conversion(GU3D_shp, "C:/Paleospeleology/Rock-Art/GU3D.tif", "0,05")

# Execute FeatureVerticesToPoints
arcpy.FeatureVerticesToPoints_management(GU3D_shp, GU_shp, "ALL")

# Use FeatureToPoint function to find a point inside each park
arcpy.FeatureToPoint_management(GU3D_shp, GUcentroid_shp, "CENTROID")
...
arcpy.Buffer_analysis("C:/Paleospeleology/Rock-Art/GU.shp", Buffer_shp, "2,99 Meters", "FULL", "ROUND", "NONE", "", "PLANAR")

# Process: Clip analysis
arcpy.Clip_analysis(OP_shp, Buffer_shp, OPs_shp)

# Process: Construct Sight Lines
arcpy.ConstructSightLines_3d(OPs_shp, "C:/Paleospeleology/Rock-Art/GU.shp", LS_shp, "grid_code", "Shape.Z", "<None>", "1", "NOT_OUTPUT_THE_DIRECTION")

# Process: Intervisibility
arcpy.Intervisibility_3d(LS_shp, "C:/Paleospeleology/Topography/CeilingsMax.shp", "VISIBLE")
...
# Process: Join Field 
arcpy.JoinField_management("C:/Paleospeleology/Rock-Art/GU.shp", "FID", TargetStatistics_dbf, "OID_TARGET", "COUNT_OID_")

# Process: Add Field 
arcpy.AddField_management("C:/Paleospeleology/Rock-Art/GU.shp", "Frequency", "DOUBLE", 100, 10, 10, "", "NON_NULLABLE", "NON_REQUIRED")

## input file 
file2 = "C:/Paleospeleology/Rock-Art/GU.shp"
...
# Process: Point to Raster 
arcpy.PointToRaster_conversion("C:/Paleospeleology/Rock-Art/GU.shp", "Frequency", TargetFrequency_tif, "MAXIMUM", "NONE", "0,25")
...
# Process: Near
arcpy.analysis.Near("C:/Paleospeleology/Rock-Art/GUcentroid.shp", "C:/Paleospeleology/Metadata/OPs.shp")

# Process: Join Field 
arcpy.JoinField_management("C:/Paleospeleology/Metadata/OPs.shp", "FID", "C:/Paleospeleology/Rock-Art/GUcentroid.shp", "NEAR_FID", "NEAR_FID;NEAR_DIST")
...
# Process: Join Field 
arcpy.JoinField_management("C:/Paleospeleology/Accessibility/EstimatedPositionArtist.shp", "NEAR_FID", "C:/Paleospeleology/Rock-Art/GUcentroid.shp", "NEAR_FID", "GU")
...
# Process: Add Surface Information
arcpy.ddd.AddSurfaceInformation("C:/Paleospeleology/Rock-Art/GUcentroid.shp", "C:/Paleospeleology/Rock-Art/GU3D.tif", "Z")

# Process: Add Field
arcpy.AddField_management("C:/Paleospeleology/Rock-Art/GUcentroid.shp", "GUs_Z", "DOUBLE", 100, 10, 10, "", "NON_NULLABLE", "NON_REQUIRED")

# Process: Calculate Field
arcpy.CalculateField_management("C:/Paleospeleology/Rock-Art/GUcentroid.shp", "GUs_Z", "[Z]", "VB", "")

# Process: Join Field 
arcpy.JoinField_management("C:/Paleospeleology/Accessibility/EstimatedPositionArtist.shp", "NEAR_FID", "C:/Paleospeleology/Rock-Art/GUcentroid.shp", "NEAR_FID", "GUs_Z")

# Process: Add Surface Information
arcpy.ddd.AddSurfaceInformation("C:/Paleospeleology/Accessibility/EstimatedPositionArtist.shp", "C:/Paleospeleology/Topography/GroundOK.tif", "Z")
...
# Process: Calculate Field
arcpy.CalculateField_management("C:/Paleospeleology/Accessibility/EstimatedPositionArtist.shp", "Distance", "[GUs_Z] - [Z]", "VB", "")

# Process: Add Field
arcpy.AddField_management("C:/Paleospeleology/Accessibility/EstimatedPositionArtist.shp", "Posture", "TEXT", "", "", 50, "")
